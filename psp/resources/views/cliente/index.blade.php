...
<div class="container-fluid">
    ...
    @endif
    <div class="mb-3">
    <a class="btn btn-primary" href="{{url('/cliente/create')}}" role="button">Nuevo</a>
    </div>
    <table class="table table-dark table-hover table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$p->country}}</td>
                <td>
                    <a class="btn btn-primary" href="{{url('/cliente/'.$p->id.'/edit')}}" role="button">Editar</a>
                </td>

                <td>
                    <form action="{{url('/cliente/'.$p->id)}}" method="post">
                        @csrf
                        {{method_field('DELETE')}}
